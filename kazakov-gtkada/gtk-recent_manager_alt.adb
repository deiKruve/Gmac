...
--                                                                    --
--                                Last revision :  12:36 17 Sep 2011  --
--                                                                    --
...
package body Gtk.Recent_Manager_Alt is
   ...
   function Get_For_Screen (Screen : Gdk_Screen)
      ...
      function Internal (Screen : Gdk_Screen) return System.Address;
      pragma Import (C, Internal, "gtk_recent_manager_get_for_screen");
      Stub : Gtk_Recent_Manager_Record;
   begin
      return
         Gtk_Recent_Manager
         (  Get_User_Data_Fast (Internal (Screen), Stub)
         );
   end Get_For_Screen;
   ...
   procedure Set_Limit
      ...
      procedure Internal (Manager : System.Address; Limit : GInt);
