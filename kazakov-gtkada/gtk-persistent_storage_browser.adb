...
--                                                                    --
--                                Last revision :  14:32 02 Jun 2012  --
--                                                                    --
...
package body Gtk.Persistent_Storage_Browser is
   ...
   Persistent_Storage_Tree_View_Class_Record : GObject_Class :=
      Uninitialized_Class;
   Persistent_Storage_Items_View_Class_Record : GObject_Class :=
      Uninitialized_Class;
   ...
   begin
      ...
      if Length = 0 then
         Raise_Exception (Name_Error'Identity, "Empty path");
      end if;
      Storage :=
         Ptr
         (  Find
   ...
   function Get_Directory_Cache
            (  Widget : access Gtk_Persistent_Storage_Items_View_Record
            )  return Gtk_Persistent_Directory is
      Cache : Gtk_Abstract_Directory := Get_Cache (Widget);
   begin
      return
   ...
   procedure Install (Class : GObject_Class) is
   begin
   ...
   procedure Initialize
      ...
      To_Install : constant Boolean :=
          Persistent_Storage_Tree_View_Class_Record =
             Uninitialized_Class;
   begin
      Gtk.Abstract_Browser.Initialize
      (  Widget,
         Store,
         Selected
      );
   ...
   begin
       case Data.Mode is
         ...
         when Catalogue =>
            ...
            declare
               Name  : String renames
                          To_String (Get (Data.Folder, Data.Index));
