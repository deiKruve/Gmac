...
package body GIO.Drive is
   ...
   function Can_Eject (Drive : access GDrive_Record) return Boolean is
   ...
   function Get_Name (Drive : access GDrive_Record)
   ...
   function Get_Icon (Drive : access GDrive_Record) return GObject is
   ...
   function Has_Media (Drive : access GDrive_Record) return Boolean is
      function Internal (Drive : Address) return GBoolean;
   ...
   function Has_Volumes (Drive : access GDrive_Record) return Boolean is
      function Internal (Drive : Address) return GBoolean;
