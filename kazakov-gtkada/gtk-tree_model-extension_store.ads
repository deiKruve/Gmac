...
private
   ...
   record
      Reference : Gtk_Tree_Model; -- The reference model
      Columns   : Gtk_Tree_Store; -- The columns added
      Offset    : GInt := 0;      -- Columns in the reference model
...
--
   procedure Finalize (Model : access Gtk_Extension_Store_Record);
--
