...
--     Gtk.Object.Checked_Destroy                  Luebeck            --
...
procedure Gtk.Object.Checked_Destroy
          (  Object : access Gtk_Object_Record'Class
          )  is
   procedure Gtk_Object_Destroy (Object : Address);
   pragma Import (C, Gtk_Object_Destroy, "gtk_object_destroy");
...
begin
   if This /= Null_Address then
      G_Object_Ref (This);
      if Floating_Is_Set (Object) then
...
end Gtk.Object.Checked_Destroy;
