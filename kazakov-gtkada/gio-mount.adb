...
package body GIO.Mount is
   ...
   function Can_Eject (Mount : access GMount_Record) return Boolean is
   ...
   function Can_Unmount (Mount : access GMount_Record) return Boolean is
      function Internal (Mount : Address) return GBoolean;
   ...
   function Get_Name (Mount : access GMount_Record)
   ...
   function Get_Icon (Mount : access GMount_Record) return GObject is
   ...
   function Get_Root (Mount : access GMount_Record)
      return UTF8_String is
   ...
   function Get_UUID (Mount : access GMount_Record)
      return UTF8_String is
      function Internal (Mount : Address) return Chars_Ptr;
