...
package body Gtk.Generic_Enum_Combo_Box is
   ...
   function Apply_Style
     (To : String;
      ...
      Replace_Underscore_By_Space : Boolean) return String is
   ...
   procedure Initialize
     (Combo : access Gtk_Enum_Combo_Box_Record'Class;
      ...
      CB : constant Gtk.Combo_Box.Gtk_Combo_Box
                 := Gtk.Combo_Box.Gtk_Combo_Box (Combo);
   begin
      Gtk.Combo_Box.Initialize_Text (Combo);
      for I in Enum_Type loop
         Gtk.Combo_Box.Append_Text
           (CB,
            Apply_Style
              (Enum_Type'Image (I), Style, Replace_Underscore_By_Space));
      end loop;
   end Initialize;
   ...
   exception
      when others =>
         Gtk.Object.Checked_Destroy (Combo);
         Combo := null;
         raise;
   end Gtk_New;
   ...
   procedure Set_Active_Value
     (Combo : access Gtk_Enum_Combo_Box_Record;
      ...
      CB : constant Gtk.Combo_Box.Gtk_Combo_Box
                 := Gtk.Combo_Box.Gtk_Combo_Box (Combo);
   begin
      Gtk.Combo_Box.Set_Active (CB, Enum_Type'Pos (Value));
   end Set_Active_Value;

   function Get_Active_Value
     (Combo : access Gtk_Enum_Combo_Box_Record) return Enum_Type is
      CB : constant Gtk.Combo_Box.Gtk_Combo_Box
                 := Gtk.Combo_Box.Gtk_Combo_Box (Combo);
      Active_Index : constant Glib.Gint := Gtk.Combo_Box.Get_Active (CB);
      use type Glib.Gint;
   begin
