...
--
-- Get_For_Screen -- The manager of a screen
--
--    Screen - A screen
--
-- Returns :
...
--
   function Get_For_Screen (Screen : Gdk_Screen)
...
--
-- Get_Limit -- The maximal number of items in Get_Items
--
--    Manager - A manager
--
-- Returns :
--
--    The upper limit of items or -1 if unlimited
--
   function Get_Limit
            (  Manager : access Gtk_Recent_Manager_Record
            )  return GInt;
...
--
-- Set_Limit -- The maximal number of items in Get_Items
--
--    Manager - A manager
--    Limit   - The upper limit of items or -1 if unlimited
--
   procedure Set_Limit
             (  Manager : access Gtk_Recent_Manager_Record;
                Limit   : GInt
