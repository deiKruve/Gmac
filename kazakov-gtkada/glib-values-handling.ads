...
--
-- Set_Object -- Set an object into GValue
--
--    Value  - The value
--    Object - The object
--
-- This  procedure  sets  an object into value. The value must have been
-- initialized with the object's type before the call.
--
