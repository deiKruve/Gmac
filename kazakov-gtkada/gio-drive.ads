...
--
   function Can_Eject (Drive : access GDrive_Record) return Boolean;
--
...
--    The drive or null
--
   function Get_Drive (Volume : access GVolume_Record'Class)
      return GDrive;
   function Get_Drive (Mount  : access GMount_Record'Class)
      return GDrive;
--
...
--    The icon or null
--
   function Get_Icon (Drive : access GDrive_Record) return GObject;
--
...
--    The name
--
   function Get_Name (Drive : access GDrive_Record) return UTF8_String;
--
...
--
   function Has_Media (Drive : access GDrive_Record) return Boolean;
--
-- Has_Volumes -- Check
--
--    Drive - A drive
...
--
   function Has_Volumes (Drive : access GDrive_Record) return Boolean;
--
...
--
   function Is_Media_Check_Automatic (Drive : access GDrive_Record)
      return Boolean;
--
...
--
   function Is_Media_Removable (Drive : access GDrive_Record)
      return Boolean;
