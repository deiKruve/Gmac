...
--
   function Get_Authors
            (  Scheme : access Gtk_Source_Style_Scheme_Record
...
--
   function Get_ID (Scheme : access Gtk_Source_Style_Scheme_Record)
      return UTF8_String;
--
...
--    The name
--
   function Get_Name (Scheme : access Gtk_Source_Style_Scheme_Record)
      return UTF8_String;
--
