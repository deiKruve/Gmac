...
--    item-deleted  - An item was deleted.  The  first parameter is  the
--                    path of deleted item.
...
--
   type Gtk_Abstract_Directory_Record is
      abstract new Gtk_Tree_Model_Record with private;
...
--
   procedure Finalize (Model : access Gtk_Abstract_Directory_Record);
--
...
--    Widget - The directory items view
--
   procedure Refresh (Widget : access Gtk_Directory_Items_View_Record);
--
-- Renamed -- Item renaming notification
--
--    Widget - The directory items view
...
--
   ...
   package Tree_Functions is
      new Cell_Data_Functions (Gtk_Directory_Tree_View);
--
...
--
   ...
   record
      Cache   : Gtk_Abstract_Directory;
      View    : Gtk_Directory_Items_View;
      Root    : Gtk_Tree_Path; -- Current root
      Deleted : Gtk_Tree_Path; -- Being deleted
...
--
   procedure Finalize (Model : access Gtk_Directory_Items_Store_Record);
--
...
------------------------------------------------------------------------
   ...
   package Column_Functions is new Cell_Data_Functions (Column_Data);
--
...
--
   ...
   function From_Address is
      new Ada.Unchecked_Conversion (System.Address, Traced_Actions);
   function To_Address is
      new Ada.Unchecked_Conversion (Traced_Actions, System.Address);
