...
--
   procedure Finalize (Model : access Gtk_Abstract_Model_Record);
--
...
--    The GTK+ flags
--
   function Get_Flags (Model : access Gtk_Abstract_Model_Record)
...
--
   function Get_N_Columns (Model : access Gtk_Abstract_Model_Record)
...
private
   type Gtk_Abstract_Model_Record is
      abstract new Gtk_Tree_Model_Record with null record;
...
--
   ...
   type C_Model_Record is record
      Parent         : C_GObject_Record;
      Implementation : Gtk_Abstract_Model_Record_Ptr;
   end record;
   pragma Convention (C, C_Model_Record);
   type C_Model_Record_Ptr is access all C_Model_Record;
   pragma Convention (C, C_Model_Record_Ptr);
--
