...
--                                                                    --
--                                Last revision :  21:29 05 May 2008  --
--                                                                    --
...
private
   ...
   record
      Reference : Gtk_Tree_Model;              -- Reference model
      Columns   : GInt          := 1;          -- The number of columns
      Rows      : GInt          := 0;          -- The number of rows
      Root      : Gtk_Tree_Iter := Null_Iter;  -- The root node
      Path      : Gtk_Tree_Path;               -- Its path
...
--
   procedure Erase (Model : access Gtk_Columned_Store_Record);
--
...
--
   procedure Finalize (Model : access Gtk_Columned_Store_Record);
--
