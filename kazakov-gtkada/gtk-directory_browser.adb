...
package body Gtk.Directory_Browser is
   ...
   function Compare
            (  Store     : access Gtk_Directory_Record;
               Directory : Item_Path;
               A, B      : Directory_Item;
               By_Name   : Boolean
            )  return Row_Order is
   ...
   function Filter
            (  Widget    : access Gtk_Directory_Browser_Record;
               Directory : Boolean;
               Name      : Item_Name;
               Kind      : Item_Type
            )  return Boolean is
   ...
   function Filter
            (  Widget    : access Gtk_Files_View_Record;
               Directory : Boolean;
               Name      : Item_Name;
               Kind      : Item_Type
            )  return Boolean is
   ...
   function Get_Icon
            (  Widget       : access Gtk_Folders_View_Record;
               Kind         : Item_Type;
               Expanded     : Boolean;
   ...
   procedure Initialize
             (  Store   : access Gtk_Directory_Record'Class;
   ...
   procedure Initialize
             (  Widget    : access Gtk_Directory_Browser_Record'Class;
                File      : UTF8_String;
                Columns   : Positive;
                Vertical  : Boolean;
                Tree_Size : Gtk_Requisition;
