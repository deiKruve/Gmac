...
--
--     My_Class_Record : GObject_Class := Uninitialized_Class;
--
...
--     should use Class_Install_Style_Property_Parser instead  of  plain
--     Class_Install_Style_Property. The parser then should take care of
...
--
-- Class_Find_Style_Property -- Find a style property
--
--    Class         - The class
--    Property_Name - The propery name
--
-- This  function  finds  Property_Name  of  Class.  If  it  has no such
-- property,  the  result  is   null.   Otherwise,   it   the   property
-- specification.  Only the style properties Class has, can be requested
-- for their values.
--
-- Returns :
--
--    The property specification or null
--
