...
--
-- Get_Mark_Category_Background -- Get the color of a category of marks
--
--    Widget   - The widget
--    Category - The category
--
-- The  result  has  the  Color field set to the background color. If no
-- background color set, the result has Has_Color discriminant False.
--
-- Returns :
--
...
--
-- Get_Mark_Category_Pixbuf -- Get the pixbuf of a category of marks
--
--    Widget   - The widget
--    Category - The category
--
...
--
-- Get_Mark_Category_Priority -- Get the priority of a category of marks
--
--    Widget   - The widget
--    Category - The category
--
...
--
-- Set_Mark_Category_Background -- Set the background color of
--
--   Widget   - The widget
--   Category - The category
-- [ Color ]  - The background color
--
-- When Color is omitted, it the background color is unset for the given
-- category of marks.
--
...
--
-- Set_Mark_Category_Pixbuf -- Set the pixbuf of a category of marks
--
--   Widget   - The widget
--   Category - The category
--   Pixbuf   - The pixbuff or null
--
-- This procedure associates a given pixbuf with a given mark  category.
-- If pixbuf is Null_Pixbuf, the pixbuf is unset.
--
...
--
-- Set_Mark_Category_Priority -- Set the priority of a category of marks
--
--   Widget   - The widget
--   Category - The category
--   Priority - The priority
--
-- When there are multiple marks on the same line, marks  of  categories
-- with higher priorities will be drawn on top.
--
