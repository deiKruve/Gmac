...
package body Gtk.Tree_Model.Generic_Sort is
   ...
   procedure Clear_Cache (Store : access Gtk_Tree_Model_Sort_Record) is
   ...
   function Compare
            (  Store  : access Gtk_Tree_Model_Sort_Record;
               Left   : Gtk_Tree_Iter;
               Right  : Gtk_Tree_Iter
   ...
   begin
      Internal (Get_Object (Store), Path);
   ...
   function Get_Model (Store : access Gtk_Tree_Model_Sort_Record)
   ...
   procedure Gtk_New
             (  Store : out Gtk_Tree_Model_Sort;
                Model : access Tree_Model_Record'Class
             )  is
   begin
   ...
   procedure Initialize
             (  Store : access Gtk_Tree_Model_Sort_Record'Class;
                Model : access Tree_Model_Record'Class
             )  is
