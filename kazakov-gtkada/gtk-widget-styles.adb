...
package body Gtk.Widget.Styles is
   ...
   begin
      return Internal (Class, Build (Property_Name));
...
--        end if;
   ...
   function Double_Type return GType is
   begin
      return GType_Double;
   end Double_Type;
   function Style_Get_Double_Impl is
       new Generic_Style_Get
           (  Double_Type,
              GDouble,
              Get_Double
   ...
   function Style_Get
            (  Widget        : access Gtk_Widget_Record'Class;
               Property_Name : UTF8_String
            )  return GDouble renames Style_Get_Double_Impl;
   ...
   function Style_Get
      ...
      Class      : GObject_Class := Class_From_Type (Get_Type (Widget));
      Parameter  : Param_Spec;
      Value      : GValue;
   begin
      Parameter := Class_Find_Style_Property (Class, Property_Name);
