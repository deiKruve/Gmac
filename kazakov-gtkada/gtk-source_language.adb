...
package body Gtk.Source_Language is
   ...
   function Get_Globs
            (  Language : access Gtk_Source_Language_Record
   ...
   function Get_Hidden (Language : access Gtk_Source_Language_Record)
      return Boolean is
   ...
   function Get_ID (Language : access Gtk_Source_Language_Record)
   ...
   begin
      return Value (Internal (Get_Object (Language)));
   end Get_Metadata;
   ...
   function Get_Name (Language : access Gtk_Source_Language_Record)
      return UTF8_String is
      function Internal (Object : Address) return Chars_Ptr;
   ...
   function Get_Section (Language : access Gtk_Source_Language_Record)
      return UTF8_String is
      function Internal (Object : Address) return Chars_Ptr;
