...
--
   function Can_Eject (Mount : access GMount_Record) return Boolean;
--
...
--
   function Can_Unmount (Mount : access GMount_Record) return Boolean;
--
...
--    The icon or null
--
   function Get_Icon (Mount : access GMount_Record) return GObject;
--
...
--    The name
--
   function Get_Name (Mount : access GMount_Record) return UTF8_String;
--
...
--
   function Get_Root (Mount : access GMount_Record) return UTF8_String;
--
...
--
   function Get_UUID (Mount : access GMount_Record) return UTF8_String;
