...
package body GIO.Volume is
   ...
   function Get_Icon (Volume : access GVolume_Record) return GObject is
   ...
   function Get_Name (Volume : access GVolume_Record)
   ...
   function Get_Volume (Mount : access GMount_Record'Class)
      return GVolume is
      function Internal (Volume : Address) return Address;
   ...
   function Should_Automount (Volume : access GVolume_Record)
      return Boolean is
