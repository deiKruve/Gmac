...
package rt_mh_appl is
   
   RS_MH_APPL_VERSION : aliased constant String := "X2.3.1" & ASCII.NUL;  
   --  rt_mh_appl.h:43
   ...
   mh_mApplFlags_NoAbortMsg     : constant mh_mApplFlags := 2;  
   ...
   type mhs_ApplMessage is 
      record
	 Id            : aliased pwr.pwr_tUInt32;
	 ...
	 SupObject     : aliased pwr.pwr_tObjid;
	 ...
	 Outunit       : aliased pwr.pwr_tObjid; 
	 ...
	 EventFlags    : aliased rt_mh_net.mh_mEventFlags;
	 -- Flags that modify the properties of a message, See mh_mEventFlags.
	 EventTime     : aliased pwr.pwr_tTime; 
	 ...
	 EventName     : aliased pwr.pwr_tString80;
   ...
   function mh_ApplCancel (id         : pwr.pwr_tUInt32; 
			   cancelText : access pwr.pwr_tString80) 
			  return pwr.pwr_tStatus;  -- rt_mh_appl.h:142
   pragma Import (C, mh_ApplCancel, "mh_ApplCancel");
   
   
   function mh_ApplConnect (ApplObject      : pwr.pwr_tObjid;
			    Flags           : mh_mApplFlags;
			    AbortEventName  : Interfaces.C.Strings.chars_ptr;
			    AbortEventType  : rt_mh_net.mh_eEvent;
			    AbortEventPrio  : rt_mh_net.mh_eEventPrio;
			    AbortEventFlags : rt_mh_net.mh_mEventFlags;
			    AbortEventText  : Interfaces.C.Strings.chars_ptr;
			    NoOfActMessages : access pwr.pwr_tUInt32) 
			   return pwr.pwr_tStatus;  
   -- Connects this application to the local Handler.
   -- rt_mh_appl.h:150
   pragma Import (C, mh_ApplConnect, "mh_ApplConnect");
   
   function mh_ApplDisconnect 
     return pwr.pwr_tStatus;  
   -- Informs the local Handler to remove this Application from its list of 
   -- known applications.
   -- rt_mh_appl.h:165
   pragma Import (C, mh_ApplDisconnect, "mh_ApplDisconnect");

   function mh_ApplMessage (Id      : access pwr.pwr_tUInt32; 
			    Message : access mh_sApplMessage) 
			   return pwr.pwr_tStatus;  
   -- Send a message to the local Handler.
   -- rt_mh_appl.h:171
   pragma Import (C, mh_ApplMessage, "mh_ApplMessage");
   
   function mh_ApplReturn (Id         : pwr.pwr_tUInt32; 
			   ReturnText : access pwr.pwr_tString80) 
			  return pwr.pwr_tStatus;  
   -- This function returnes a message previously created by this application.
   -- rt_mh_appl.h:179
   pragma Import (C, mh_ApplReturn, "mh_ApplReturn");
   
   function mh_ApplGetMsgInfo (Id      : pwr.pwr_tUInt32; 
			       Message : access mh_sApplMessage) 
			      return pwr.pwr_tStatus;  
   -- rt_mh_appl.h:186
