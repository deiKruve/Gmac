...
edit-beren:
	emacs berentest.gpr ./beren/berentest1.ads ./beren/berentest1.adb ./beren/beren-thread.adb ./beren/beren-thread.ads ./beren/beren-err.adb ./beren/beren-err.ads ./beren/beren-hw.adb ./beren/beren-hw.ads ./beren/beren-jog.adb ./beren/beren-jog.ads ./beren/beren-jogobj.adb ./beren/beren-jogobj.ads ./beren/beren-objects.adb ./beren/beren-objects.ads ./beren/beren.ads berentest.adb