...
procedure Test_Strings_Edit is
   ...
   procedure TestFloat (Value : Float; Base : NumberBase := 10) is
      Eps     : constant :=
   ...
   end TestRelPrecision;

   procedure TestAbsPrecision
             (  Value  : Float;
                Small  : Integer;
                Result : String
             )  is
   ...
   end TestAbsPrecision;

   procedure TestInteger (Value : Integer; Base : NumberBase := 10) is
      Text    : String (1..68);
      Temp    : Integer;
      Pointer : Integer;
   begin
...
begin
   ...
   TestJustify ("#", 10, Left,   "#         ");
   TestJustify ("#", 10, Right,  "         #");
   TestJustify ("#", 10, Center, "    #     ");

   TestJustify ("##########", 10, Left,   "##########");
   TestJustify ("##########", 10, Right,  "##########");
   TestJustify ("##########", 10, Center, "##########");

   TestRelPrecision (2.345678, 1, "2");
   TestRelPrecision (2.345678, 2, "2.3");
   TestRelPrecision (2.345678, 3, "2.35");
   TestRelPrecision (2.345678, 4, "2.346");
   TestRelPrecision (2.345678, 5, "2.3457");

   TestAbsPrecision (2.345678, 1, "0");
   TestAbsPrecision (2.345678, 0, "2");
   TestAbsPrecision (2.345678,-1, "2.3");
   TestAbsPrecision (2.345678,-2, "2.35");
   TestAbsPrecision (2.345678,-3, "2.346");
   TestAbsPrecision (2.345678,-4, "2.3457");

   for Base in NumberBase'Range loop
      TestFloat (Float'Last,  Base => Base);
      TestFloat (Float'First, Base => Base);
   end loop;

   TestFloat (1.2e37, Base => 2);
   TestFloat (1.2e37, Base => 16);
   TestFloat (1.2e37);
   TestFloat (123.45);
   TestFloat (0.00000012345);
   TestFloat (0.000000000000012345);
   ...
   for Base in NumberBase'Range loop
      TestInteger (Integer'Last, Base => Base);
      TestInteger (Integer'First, Base => Base);
   end loop;

   TestInteger (0);
   TestInteger (-6);
   TestInteger (12345);
   TestInteger (Integer'First);
   TestInteger (Integer'Last);
