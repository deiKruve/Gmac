...
package body Closed_Bezier_Spline_Test is
   ...
   begin
	 ...
	 if I = Rhs'Last then
      ...
      Plx := Cyclic_Solve (A, B, C, 1.0, 1.0, Rhs);
      
      -- First equation
      Ass.Assert (abs ((4.0 * Knots (Knots'First).X + 2.0 * Knots (Knots'First + 1).X) - 
			 (Plx (Knots'Last) + 4.0 * Plx (Knots'First) + Plx (Knots'First + 1))) 
	 ...
	 Ass.Assert (abs ((4.0 * Knots (I).X + 2.0 * Knots (I + 1).X) - 
      ...
      Ass.Assert (abs ((4.0 * Knots (Knots'Last).X + 2.0 * Knots (Knots'First).X) - 
			 (Plx (Knots'Last - 1) + 4.0 * Plx (Knots'Last) + Plx (Knots'First))) 
	 ...
	 if I = Rhs'Last then
      ...
      -- First equation
      Ass.Assert (abs ((4.0 * Knots (Knots'First).Y + 2.0 * Knots (Knots'First + 1).Y) - 
			 (Plx (Knots'Last) + 4.0 * Plx (Knots'First) + Plx (Knots'First + 1))) 
